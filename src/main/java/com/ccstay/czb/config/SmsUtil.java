...
//        }
     ...
     * @throws ClientException
     */
    public  QuerySendDetailsResponse querySmsSendDetails(String phoneNumbers, String bizId, String sendDate, long currentPage, long pageSize) throws ClientException {
        //设置超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        //此处需要替换成开发者自己的AK信息
