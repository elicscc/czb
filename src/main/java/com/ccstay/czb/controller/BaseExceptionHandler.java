...
//    @ResponseBody
    public Result error(Throwable e){
        //记录日志（发邮件、发短信、、、、）
        //System.err.println("记录日志：发生了异常");
       // e.printStackTrace();
        //返回响应结果
//        return  new Result(false, StatusCode.ERROR,"系统异常繁忙");
        return  new Result(System.currentTimeMillis(), StatusCode.ERROR,e.getMessage(),null);
    }
